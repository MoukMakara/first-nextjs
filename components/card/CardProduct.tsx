...
export default function CardProduct({
  ...
  return (
    <div>
      ...
      <div
        onClick={onClick}
        className="cursor-pointer rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800"
      >
        ...
        <div className="pt-6">
          ...
          <a
            href="#"
            className="text-lg line-clamp-1 font-semibold leading-tight text-gray-900 hover:underline dark:text-white"
          >
            {title}
          </a>
